...
const ZUERICH_GEMEINDEN = [
  "Zürich","Winterthur","Uster","Dübendorf","Dietikon","Wetzikon",
  "Wädenswil","Bülach","Horgen","Opfikon","Kloten","Schlieren",
  "Volketswil","Adliswil","Regensdorf","Thalwil","Illnau-Effretikon",
  "Wallisellen","Küsnacht","Stäfa","Meilen","Richterswil","Zollikon",
  "Rüti","Affoltern am Albis","Pfäffikon","Bassersdorf","Hinwil",
  "Männedorf","Maur","Gossau","Wald","Urdorf","Embrach",
  "Elgg","Bauma","Andelfingen","Wiesendangen","Nänikon",
  "Dielsdorf","Oetwil am See","Herrliberg","Erlenbach"
];
